...
Branch_faculties::Branch_faculties(const std::string &name, const std::string &NYK, const size_t num_department,
                                 const std::map<std::string, Cathedra::Cathedra> &list_cathedra) : name_(name), NYK_(NYK),
...
void Branch_faculties::set_list_cathedra(const std::map<std::string, Cathedra::Cathedra> &list_cathedra) {
    list_cathedra_ = list_cathedra;
}
...
std::map<std::string, Cathedra::Cathedra> Branch_faculties::get_list_cathedra() const {
...
size_t Branch_faculties::count_teachers() {
    ...
    for (auto cathedra: list_cathedra_) {
        for (auto disciplines : cathedra.second.disciplines_) {
