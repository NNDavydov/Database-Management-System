...
void DB_branch_faculties::create_db(const std::string &name_db) {
...
void DB_branch_faculties::print_db() {
...
void DB_branch_faculties::delete_db(const std::string &name_db) {
    fs::remove_all(path_ + separator_ + name_db);
}


void DB_branch_faculties::rename_db(const std::string &name, const std::string &new_name) {
